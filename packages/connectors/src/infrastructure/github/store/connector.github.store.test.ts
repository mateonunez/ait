...
import type { GitHubRepositoryEntity, GitHubEntity } from "../../../domain/entities/github/connector.github.entities";
  ...
  describe("save", () => {
    ...
    it("should throw an error if the item type is not supported", async () => {
      const unsupportedItem = {
        id: "unsupported-1",
        name: "Some Entity",
        type: "unsupported" as "repository", // this generates a type error
