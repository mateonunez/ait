    ...
    <div className="flex h-full w-full overflow-hidden bg-background">
      ...
      <div className="flex-1 flex flex-col min-w-0 min-h-0">
        <div className="flex-1 overflow-y-auto custom-scrollbar">
          {messages.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full px-4 sm:px-6 py-6 sm:py-8 space-y-3 sm:space-y-4">
        ...
        {showSuggestions && (
          <div className="px-3 sm:px-4 py-2 border-t border-border bg-background/50 backdrop-blur-sm">
            <Suggestions suggestions={suggestions} onSuggestionClick={handleSuggestionClick} />
          </div>
        )}

        {/* User Input */}
        <div className="px-3 sm:px-4 py-3 border-t border-border bg-background">
