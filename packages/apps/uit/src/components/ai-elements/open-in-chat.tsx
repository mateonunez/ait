...
export const OpenInChatGPT = (props: OpenInChatGPTProps) => {
  ...
  return (
    <DropdownMenuItem asChild {...props}>
      <a className="flex items-center gap-2" href={providers.chatgpt.createUrl(query)} rel="noreferrer" target="_blank">
...
export const OpenInClaude = (props: OpenInClaudeProps) => {
  ...
  return (
    <DropdownMenuItem asChild {...props}>
      <a className="flex items-center gap-2" href={providers.claude.createUrl(query)} rel="noreferrer" target="_blank">
...
export const OpenInT3 = (props: OpenInT3Props) => {
  ...
  return (
    <DropdownMenuItem asChild {...props}>
      <a className="flex items-center gap-2" href={providers.t3.createUrl(query)} rel="noreferrer" target="_blank">
...
export const OpenInScira = (props: OpenInSciraProps) => {
  ...
  return (
    <DropdownMenuItem asChild {...props}>
      <a className="flex items-center gap-2" href={providers.scira.createUrl(query)} rel="noreferrer" target="_blank">
...
export const OpenInv0 = (props: OpenInv0Props) => {
  ...
  return (
    <DropdownMenuItem asChild {...props}>
      <a className="flex items-center gap-2" href={providers.v0.createUrl(query)} rel="noreferrer" target="_blank">
...
export const OpenInCursor = (props: OpenInCursorProps) => {
  ...
  return (
    <DropdownMenuItem asChild {...props}>
      <a className="flex items-center gap-2" href={providers.cursor.createUrl(query)} rel="noreferrer" target="_blank">
