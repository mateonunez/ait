...
export const ENTITY_METADATA: Record<EntityType, EntityMetadata> = {
  ...
  spotify_playlist: {
    ...
    vendor: "spotify",
    description: "Spotify playlists (timestamps: createdAt, updatedAt)",
  ...
  github_issue: {
    ...
    vendor: "github",
    description: "GitHub issues (timestamps: issueCreatedAt, issueUpdatedAt, issueClosedAt)",
    timestampFields: ["issueCreatedAt", "issueUpdatedAt", "issueClosedAt", "createdAt", "updatedAt"],
  },
  github_file: {
    label: "Code File",
  ...
  google_calendar_calendar: {
    ...
    keywords: [
      "google_calendar_calendar",
      // English - specific to calendar management, not viewing events
      "my calendars",
      "calendar list",
      "calendar settings",
      "create calendar",
    ...
    vendor: "google",
    description: "Google Calendar calendars - for managing calendar containers, not events (timestamps: createdAt)",
    timestampFields: ["createdAt"],
  },
  ...
  gmail_message: {
    ...
    vendor: "google",
    description: "Gmail messages (timestamps: internalDate, createdAt)",
    timestampFields: ["internalDate", "createdAt"],
  },
  gmail_thread: {
    label: "Thread",
    labelPlural: "Threads",
    ...
    vendor: "google",
    description: "Gmail threads (timestamps: updatedAt)",
    timestampFields: ["updatedAt"],
  },
} as const;
